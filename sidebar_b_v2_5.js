/*!
 * SIDEBAR-B v2.5 STEP 2 (external hosted)
 * 배포: 2026-08-21
...
(function(){
  ...
  var CSS_TEXT = '' +
    ...
    '.sb-block.sb-series-block.is-collapsed .sb-series-list { max-height: none; overflow: visible; display: block; }' +
  ...
  function renderTocBlock(blockEl){
    ...
    // v2.4: 헤딩 자체의 클래스로만 제외 판정 (부모 카드 검사 X)
    //   - 부모 카드 검사하면 CTA 카드 등 안에 사용자가 넣은 진짜 본문 헤딩도 제외됨
    //   - Ghost 편집기의 "특수 카드 내부 자동 생성 헤딩"에는 
    //     반드시 .kg-*-heading 계열 클래스가 붙음 → 그것만 제외하면 됨
