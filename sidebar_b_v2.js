/*!
 * SIDEBAR-B v2 STEP 2 (external hosted)
 * 배포: 2026-08-21
...
(function(){
  ...
  function renderSeriesBlock(blockEl){
    ...
    fetch(url)
      ...
      .then(function(data){
        ...
        title.innerHTML = '<span>시리즈 · ' + escapeHTML(seriesName) + '</span>' +
          '<span class="sb-title-badge">전 ' + posts.length + '회</span>';
  ...
  function renderTocBlock(blockEl){
    ...
    var title = document.createElement('div');
    title.className = 'sb-block-title';
    title.innerHTML = '<span>목차</span>' +
      '<span class="sb-title-badge">' + used.length + '개 항목</span>';
