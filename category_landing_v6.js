/*!
 * CATEGORY-LANDING v6 (external hosted)
 * 배포: 2026-08-21
...
(function(){
  ...
  var CSS = ''
    ...
    + '  padding: 0 !important;'
    + '  border: none !important;'
    + '  border-top: 1.5px solid var(--color, #0F3A3A) !important;'
    + '  border-bottom: 1.5px solid var(--color, #0F3A3A) !important;'
  ...
  function injectCSS(){
    try {
      ...
      style.setAttribute('data-ddl-cat-landing', 'v6');
